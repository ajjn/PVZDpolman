...
class Test02_signED(unittest.TestCase):
    def runTest(self):
        ...
        entitydescriptor_file = os.path.abspath('testdata/idpExampleOrg.xml')
        ...
        cliClient = CliPAtoolInvocation(['-v', '-m', md_signingcerts_file, '-s', entitydescriptor_signed_file, 'signED',
