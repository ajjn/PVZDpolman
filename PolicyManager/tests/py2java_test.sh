...
$JAVA_HOME/bin/java at.wien.ma14.pvzd.validatexsd.cli.XSDValidatorCLI testdata/PEP/01/idp4TestExampleOrg_idpXml.xml

echo
echo "$0 (3):Calling VerifySig (from Java)"
$JAVA_HOME/bin/java at.wien.ma14.pvzd.verifysigapi.cli.VerifySigCLI testdata/PEP/03/policyDirectory_basic_MOA/policydir/pol_journal.xml
