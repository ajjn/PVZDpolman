...
export certificate_file="${cd}/testdata/redmineIdentineticsCom-cer.pem"
export entitydescriptor_file="${cd}/work/idpExampleOrg.xml"
export entitydescriptor_signed_file="${cd}/work/redmineIdentineticsOrg_signed.xml"
...
~/.virtualenvs/pvzd34/bin/python \
    ...
    -r IDP \
    -s $entitydescriptor_signed_file \
    createED \
    $certificate_file \
